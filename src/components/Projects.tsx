            ...
            return (
              <AnimatedSection key={project.title} delay={0.2 + index * 0.1}>
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="border-2 border-gray-200/80 hover:border-gray-300/80 bg-white/60 backdrop-blur-sm hover:shadow-2xl hover:-translate-y-2 hover:scale-[1.02] transition-all duration-300 h-full min-h-[480px] group-hover:-translate-y-2">
